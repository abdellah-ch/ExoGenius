...
const ExamSpaceComponent = () => {
    ...
    if (!IsStudentExist && !IsLoading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
                <h1 className="text-3xl font-bold text-gray-800 mb-4">Welcome to the exam workspace</h1>
                <h2 className="text-xl text-gray-700 mb-8">Please enter your FullName and Studentid</h2>
                <form onSubmit={handleSubmit} className="w-full max-w-sm">
                    <div className="mb-4">
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" name="name" placeholder="FullName" />
                    </div>
                    <div className="mb-6">
                        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" type="text" name="id" placeholder="StudentId" />
                    </div>
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-gray-100  h-[100vh]">
            ...
            <TakeExam studentId={StudentId!} studentName={StudentName!} />
        </div>
    )
}
