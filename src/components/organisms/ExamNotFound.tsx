    ...
    return(
      <div className="h-screen w-screen flex justify-center items-center">
        <div className="flex flex-col w-[100%] md:w-[40%] h-[200px] gap-4">
          <form onSubmit={handeleSubmit} className="flex  justify-between m-4 md:m-0">
            <input 
            ...
            placeholder="Exam Key" onChange={handeleChange} />
            <NavLink 
          ...
          <p className="m-4 text-red-500 md:m-0">Exam was not found please check ExamKey </p>
        </div>
      </div>
    );
}
