...
import Logo from "/images/AdminD.png";
...
function Menu({ sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  return (
    <aside
      className={` absolute left-0 top-0 z-9999 flex h-screen lg:w-50 w-20  flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
