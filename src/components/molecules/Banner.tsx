...
const Banner = () => {
  return (
    <div className="relative">
      {/* background */}
      <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-tr from-[#007aff] to-[#007aff] rounded-bl-[100px] mb-[6rem]  "></div>

      <div className="max-w-[72rem] m-auto px-[1.5rem]">
        <div className="pt-[6rem] pb-[3rem] md:pt-[6rem] md:pb-[10rem]">
          <div className="relative text-center md:text-left max-w-[36rem] m-auto md:max-w-none">
            <div className="md:w-[600px] block">
              ...
              <div className="max-w-[20rem] m-auto mb-[3rem] text-center md:justify-start md:mb-0 md:max-w-none flex flex-col md:flex-row gap-2">
                <div>
                  <button className=" w-[100%] text-white flex items-center justify-center gap-2 px-6 py-2 font-sans text-xs font-bold text-center text-gray-900 uppercase align-middle transition-all rounded-full select-none disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none hover:bg-gray-900/10 active:bg-gray-900/20 bg-[#1E293B]/70">
                    Log In
                    <svg
